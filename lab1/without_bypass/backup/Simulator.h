...
// MY CODE HERE
const int OP_FL = 0x7;
const int OP_FS = 0x27;
const int OP_FCAL = 0x53;
const int OP_FMCAL = 0x47;
const int OP_FMADD = 0x43;
const int OP_FMSUB = 0x47;
    ...
    { // start of using namespace, to reduce code duplication
      ...
      switch (inst)
      {
        ...
        case DIV:
          return iDiv; break;
        // YOUR CODE HERE
        case FMVWX: case FMVSX: case FCVTSW:
          return int2FP; break;
        case FMVXW: case FMVXS: case FCVTWS:
          return fp2Int; break;
        case FLW:
          return dataMem; break;
        case FSW:
          return memCalc; break;
        case FADDS: case FSUBS:
          return fmaAdd; break;
        case FMULS:
          return fmaMul; break;
        case FDIVS: case FSQRTS:
          return fpDiv; break;
        case FMADDS: case FMSUBS:
          return fmADSB; break;
        // MY CODE END HERE
        default:
